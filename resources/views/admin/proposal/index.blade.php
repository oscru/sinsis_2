...
@section('body')
  ...
  <section class="wow fadeIn main-admin-container">
    <header class="main-admin-header position-fixed">
        <a href={{  route('create-proposals',$project->id) }} class="">+ Crear una nueva Propuesta</a> Propuestas encontradas: {{ count($proposals) }}
     </header>    
        <div class="container projects-container">
            ...
            <div class="text-center">
                ...
                <h2>No se han encontrado proposalos.</h2>
